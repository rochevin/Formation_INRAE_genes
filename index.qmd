...
* Installer les packages du TP à la main :
  * __Gènes__: https://github.com/rochevin/Formation_INRAE_genes/wiki/Gene-enrichment-analysis
  * __Métabolites__: https://github.com/rochevin/Formation_INRAE_genes/wiki/Metabolite-enrichment-analysis
* __OU__ utiliser `renv::restore()` depuis le projet `TP` pour que l'installation se fasse toute seule

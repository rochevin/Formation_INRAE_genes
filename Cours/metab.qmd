...
-   Loss of information when converting IDs

-   Sensitive to metabolite misidentification

-   Organism-specific pathway set if available

-   Run multiple times with different pathway databases and form a consensus

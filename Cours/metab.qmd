...
MetaboAnalyst provides interfaces for ORA, single sample profiling and QEA.
ssprofiling and QEA are other enrichment methods that we will not go over during this course.
...
![](images/metexplore_mapping.png){fig-align="center" width="179"}
